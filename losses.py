...
def trades_loss(model, x_natural, y, optimizer, args, class_weights, batch_indices=None, memory_dict=None):
    ...
    class_weights = torch.as_tensor(class_weights, dtype=x_natural.dtype, device=x_natural.device)
    class_weights_mask = class_weights[y]
    ...
    p_natural = F.softmax(logits_nat, dim=1).detach()
