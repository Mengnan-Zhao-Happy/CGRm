 python DAFA.py --model_dir .\model_output\trades_dafa --dataset cifar10 --model resnet --seed 1 --dafa_warmup 70 --dafa_lambda 1.0 --overwrite --rob_fairness_algorithm dafa --loss trades

python evaluation.py --model_dir ".\model_output\cifar10\DAFALT\best.pt" --dataset cifar10 --model resnet --data_dir ".\data"

python evaluation.py --model_dir ".\model_output\cifar10\cfa_trades\best.pt" --dataset cifar10 --model resnet --data_dir ".\data"


python CFA.py --model_dir ".\model_output\cfa_trades" --dataset cifar10 --model resnet --loss trades --overwrite
python evaluation.py --model_dir ".\model_output\cfa_trades\best.pt" --dataset cifar10 --model resnet --data_dir ".\data"


python UDR.py --model_dir ".\model_output\udr_trades" --dataset cifar10 --model resnet --loss trades --beta 4 --overwrite

python UDR.py --model_dir ".\model_output\udr_pgd" --dataset cifar10 --model resnet --loss pgd --beta 1 --overwrite
...
python RobustLT.py --data_root ".\data\CIFAR10-LT-IR50" --model_dir ".\model_output\robustlt_ir50_trades" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --overwrite

python CGR_LT.py `
  --data_root ".\data\CIFAR100-LT-IR10" `
  --dataset auto `
  --model_dir ".\model_output\cifar100\cgr_lt_cifar100_ir10_trades" `
  --model resnet `
...
python CGR_LT_V2.py `
  --data_root ".\data\CIFAR100-LT-IR10" `
  --dataset auto `
  --model_dir ".\model_output\cifar100\cgr_lt_v2_cifar100_ir10_trades" `
  --model resnet `
  --base_algorithm trades `
  --robustlt_alpha 0.5 `
  --robustlt_beta 0.6 `
...
python DAFA_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model wrn-28-10 --model_dir ".\model_output\cifar100\dafa_lt_cifar100_ir10" --loss trades --epochs 110  --eval_freq 10 --batch_size 128 --test_batch_size 200 --pgd_num_steps 10 --test_pgd_num_steps 20 --dafa_warmup 70 --dafa_lambda 1.5 --overwrite

python CFA_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\cfa_lt_cifar100_ir10" --loss trades --overwrite

python UDR_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\udr_lt_cifar100_ir10" --loss trades --overwrite

python RobustLT_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\robustlt_lt_cifar100_ir10" --base_algorithm trades --overwrite
...
python TRADES_LT.py --data_root ".\data\CIFAR10-LT-IR50" --dataset auto --model resnet --model_dir ".\model_output\cifar10\TRADESLT" --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --beta 4.0 --overwrite

python UDR_LT.py --data_root ".\data\CIFAR10-LT-IR50" --dataset auto --model resnet --model_dir ".\model_output\cifar10\UDRLT" --loss trades --lamda_init 1.0 --lamda_lr 0.02 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python CFA_LT.py --data_root ".\data\CIFAR10-LT-IR50" --dataset auto --model resnet --model_dir ".\model_output\cifar10\CFALT" --loss trades --cfa_begin 10 --cfa_lambda1 0.5 --cfa_lambda2 0.5 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python DAFA_LT.py --data_root ".\data\CIFAR10-LT-IR50" --dataset auto --model resnet --model_dir ".\model_output\cifar10\DAFALT" --loss trades --dafa_lambda 1.5 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python RobustLT.py --data_root ".\data\CIFAR10-LT-IR50" --model_dir ".\model_output\cifar10\RobustLT" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --overwrite

python CGR_LT.py --data_root ".\data\CIFAR10-LT-IR50" --model_dir ".\model_output\CGRLT" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --feedback_start 10 --eval_freq 10 --weight_lambda 1.0 --conf_lambda 0.5 --beta_lambda 0.5 --margin_lambda 0.05 --margin_m 0.5 --graph_topk 3 --overwrite


CIFAR 100 LT 上的测试


python TRADES_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\TRADESLT" --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --beta 4.0 --overwrite

python UDR_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\UDRLT" --loss trades --lamda_init 1.0 --lamda_lr 0.02 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python CFA_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\CFALT" --loss trades --cfa_begin 10 --cfa_lambda1 0.5 --cfa_lambda2 0.5 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python DAFA_LT.py --data_root ".\data\CIFAR100-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\cifar100\DAFALT" --loss trades --dafa_lambda 1.5 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python RobustLT.py --data_root ".\data\CIFAR100-LT-IR10" --model_dir ".\model_output\cifar100\RobustLT" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --overwrite

python CGR_LT.py --data_root ".\data\CIFAR100-LT-IR10" --model_dir ".\model_output\cifar100\CGRLT" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --feedback_start 10 --eval_freq 10 --weight_lambda 1.0 --conf_lambda 0.5 --beta_lambda 0.5 --margin_lambda 0.05 --margin_m 0.5 --graph_topk 3 --overwrite


TinyImagenet LT 上的测试


python TRADES_LT.py --data_root ".\data\TinyImageNet-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\TinyImageNet\TRADESLT" --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --beta 4.0 --overwrite

python UDR_LT.py --data_root ".\data\TinyImageNet-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\TinyImageNet\UDRLT" --loss trades --lamda_init 1.0 --lamda_lr 0.02 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python CFA_LT.py --data_root ".\data\TinyImageNet-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\TinyImageNet\CFALT" --loss trades --cfa_begin 10 --cfa_lambda1 0.5 --cfa_lambda2 0.5 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python DAFA_LT.py --data_root ".\data\TinyImageNet-LT-IR10" --dataset auto --model resnet --model_dir ".\model_output\TinyImageNet\DAFALT" --loss trades --dafa_lambda 1.5 --epochs 110 --eval_freq 10 --pgd_num_steps 10 --test_pgd_num_steps 20 --batch_size 128 --test_batch_size 200 --overwrite

python RobustLT.py --data_root ".\data\TinyImageNet-LT-IR10" --model_dir ".\model_output\TinyImageNet\RobustLT" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --overwrite

python CGR_LT.py --data_root ".\data\TinyImageNet-LT-IR10" --model_dir ".\model_output\TinyImageNet\CGRLT" --model resnet --base_algorithm trades --robustlt_alpha 0.3 --robustlt_beta 0.8 --feedback_start 10 --eval_freq 10 --weight_lambda 1.0 --conf_lambda 0.5 --beta_lambda 0.5 --margin_lambda 0.05 --margin_m 0.5 --graph_topk 3 --overwrite
